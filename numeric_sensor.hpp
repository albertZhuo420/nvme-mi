...
class NumericSensor {
  ...
  private:
	...
	std::unique_ptr<sdbusplus::asio::dbus_interface> thresholdInterfaceWarning {};
	std::unique_ptr<sdbusplus::asio::dbus_interface> thresholdInterfaceCritical {};
  ...
  protected:
	...
	std::optional<ThresholdInterface> selectThresholdInterface(const thresholds::Threshold &threshold);
};
}  // namespace nvmemi
